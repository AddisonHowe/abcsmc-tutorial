...
if SCRIPT:
    ...
    parser.add_argument('-v', "--var_const", type=float, default=1)
...
# Image output
imgdir = f"../../out/images/nb_ellipsoid_unspecified_{KERNEL_METHOD}"
...
if SCRIPT:
    ...
    if args.imgdir:
        ...
        imgdir = f"{args.outdir}/nb_ellipsoid_unspecified_{KERNEL_METHOD}"
