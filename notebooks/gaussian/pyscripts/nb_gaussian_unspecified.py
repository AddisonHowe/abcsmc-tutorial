...
# Image output
imgdir = f"../../out/images/nb_gaussian_unspecified_{KERNEL_METHOD}"
...
if SCRIPT:
    ...
    if args.imgdir:
        ...
        imgdir = f"{args.outdir}/nb_gaussian_unspecified_{KERNEL_METHOD}"
...
# Model object
model = GaussianModel(0, 0, ndraws=ndraws)
